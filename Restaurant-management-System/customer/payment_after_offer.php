...
if(isset($_REQUEST['submit']))
{
	...
	$sql = "call la_bourse.payment_after_offer('".$input_payment_id."');";
        //echo $sql;
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="page-title-box">
								...
								<h4 class="page-title">Applying Valid Offer </h4>
								...
								<div class="col-lg-8">
									<div class="panel panel-color panel-success">
										<div class="panel-heading">
											<h3 class="panel-title">Payment after applying offer</h3>
											<p class="panel-sub-title font-13 text-muted">Sub title goes here with small font</p>
										</div>
										<div class="panel-body">
