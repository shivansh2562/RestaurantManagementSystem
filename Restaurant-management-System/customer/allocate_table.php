					...
					<div class="row">
						<div class="col-sm-12">
							<div class="page-title-box">
								...
								<h4 class="page-title">Allocating Tables </h4>
										...
										<div class="panel-body">
											...
											<form action="">
												<div class="form-group" >
														Number of people <input type="number" class="form-control" name="members"><br>
														Reservation ID <input type="number" class="form-control" name="reserve_id"><br>
								...
								<div class="col-lg-8">
									<div class="panel panel-color panel-success">
										<div class="panel-heading">
											<h3 class="panel-title">Assigned table to user</h3>
											<p class="panel-sub-title font-13 text-muted">Sub title goes here with small font</p>
										</div>
										<div class="panel-body">
