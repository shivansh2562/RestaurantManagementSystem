...
{
	$input_payment_id = $_REQUEST['input_payment_id'];
	$input_payment_mode = $_REQUEST['input_payment_mode'];


	$sql = "call la_bourse.payment_after_discount('".$input_payment_id."', '".$input_payment_mode."');";
        //echo $sql;
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="page-title-box">
								...
								<h4 class="page-title">Amount After Discount </h4>
										...
										<div class="panel-body">
											...
											<form action="">
												<div class="form-group" >
														Payment ID <input type="number" class="form-control" name="input_payment_id"><br>
														Payment Mode <input type="text" class="form-control" name="input_payment_mode"><br>
													</div>
													<hr/>
								...
								<div class="col-lg-8">
									<div class="panel panel-color panel-success">
										<div class="panel-heading">
											<h3 class="panel-title">Payment amount after applying discount on basis of payment mode</h3>
											<p class="panel-sub-title font-13 text-muted">Sub title goes here with small font</p>
										</div>
										<div class="panel-body">
